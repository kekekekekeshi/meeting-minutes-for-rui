        ...
        try {
            ...
            const pollInterval = setInterval(async () => {
                try {
                    ...
                    console.log('Process status:', statusResponse);
                    ...
                    if (result.status === 'completed' && result.data) {
                        ...
                        if (MeetingName) {
                            ...
                            setMeetings((prev: CurrentMeeting[]) => prev.map(m => m.id === meeting.id ? {
                                ...m,
                                title: MeetingName
                            } : m));
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24"
                                        ...
                                        <path strokeLinecap="round" strokeLinejoin="round"
                                              d="M15.666 3.888A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V7.5l-3.75-3.612z"/>
                                        <path strokeLinecap="round" strokeLinejoin="round"
                                              d="M15 3v3.75a.75.75 0 0 0 .75.75H18"/>
                                    </svg>
                    ...
                    {isSummaryLoading ? (
                        <div className="flex items-center justify-center h-full">
                            <div className="text-center">
                                <div
                                    className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500 mb-4"></div>
                        ...
                        <div className="max-w-4xl mx-auto p-6">
                            {summaryResponse && (
                                <div
                                    className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
